"""
Base settings for Igrzyska project.
...
# (igrzyska/backend/config/settings/base.py - 3 = igrzyska/backend) or inside docker container is path /app
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'igrzyska.contrib.sites.migrations'
}
...
# CELERY
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['igrzyska.taskapp.celery.CeleryConfig']
