...
// --- github ---
deployLink = "https://ci.10clouds.com/job/igrzyska/job/igrzyska/parambuild?deploy=true"
gitHubOrgName = "10clouds"
// --- slack ---
slackChannel = "#igrzyska-notifications"
            ...
            if(env.CHANGE_ID != null && !params.deploy) {
                def body = [
                    body: """
                        ...
                        - [Deploy](${deployLink}) this change to [DEV](https://igrzyska.dev.10clouds.io)
                    """.stripIndent()
                ]
                httpRequest (
