"""
Production settings for Igrzyska project.
...
API_MIDDLEWARE = ['igrzyska.contrib.middleware.VersionMiddleware', ]
...
SENTRY_RELEASE = f'igrzyska@{APP_VERSION}'
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['igrzyska.dev.10clouds.io', ])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL', default='Igrzyska <noreply@igrzyska.dev.10clouds.io>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Igrzyska]')
